...
Date.fullYearStart = "20"; (function() {
	...
	d.extend(a.prototype, {
		...
		display: function(e) {
			...
			n.append(d("<div></div>").attr(o).css(j).append(d("<h2></h2>"), d('<div class="dp-nav-prev"></div>').append(d('<a id="dp-nav-prev-year" href="#" title="' + d.dpText.TEXT_PREV_YEAR + '">&laquo;</a>').bind("click",
			function() {
