...
(function() {
  ...
  $.fn.iOSCheckbox = function(options) {
    ...
    $(window).load(function() {
      $('.EditFolderBody .input :checkbox').iphoneStyle();
      $('.subFollowingBody :checkbox').iphoneStyle();
      $('.rightBtnOnOff :checkbox').iphoneStyle();
      $('.assessmentListTitleBar :checkbox').iphoneStyle();
      $('.questionType :checkbox').iphoneStyle();
      $('.questionOptions :checkbox').iphoneStyle();
      $('.endPollFooter :checkbox').iphoneStyle();
